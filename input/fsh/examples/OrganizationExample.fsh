...
* identifier[aslRegione].value = $cs-asl#120202
* identifier[aziendaOspedaliera].system = "urn:oid:2.16.840.1.113883.2.9.4.1.2"
* identifier[aziendaOspedaliera].value = $cs-aziendaOspedaliera#120902
...
* identifier[asl].system = "urn:oid:2.16.840.1.113883.2.9.4.1.1"
* identifier[asl].value = #120202
* active = 	true
